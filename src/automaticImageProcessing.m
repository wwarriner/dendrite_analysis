...
for i = 1:numImages
    ...
    % Final plot.
    xlabel = 'Radius $r \left(\mu m\right)$';
    y1label = 'Box Count Ratio Local Slope';
    y2label = 'Estimate of $\beta$';
    box_count_figh = dualplot(sprange,dd,sx1,y1,loi,hii,beta1,xlabel,y1label,y2label);
    ...
    y2label = 'Estimate of $\nu$';
    correlation_figh = dualplot(sprange,dd,sx1,y1,loi,hii,nu1,xlabel,y1label,y2label);
