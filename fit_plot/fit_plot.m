file_path = '..\example\Al9wt.Si 3kmm 0.03mms 0mT_No2  1 mod_OUT.csv';
...
ph4 = plot( axh, [ scale( 1 ) scale( end - 1 ) ], [ mean_sig_fit mean_sig_fit ] );
ph4.Color = 'k';
ph4.LineStyle = ':';
ph4.Marker = 'none';
...
export_fig( fullfile( pwd, 'fit_plot.png' ), '-png', figh );
export_fig( fullfile( pwd, 'fit_plot.eps' ), '-eps', figh );